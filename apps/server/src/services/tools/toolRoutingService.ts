...
function detectQuestionLanguage(question: string) {
  return /\b(?:fai[st](?:-|\s)?moi|donne(?:-|\s)?moi|tu connais|connais[- ]?tu|r(?:e|\u00e8|\u00e9|\?|\ufffd|\u00c3\u00a8|\u00c3\u00a9)gles?|comment jouer|comment joue[- ]?t[- ]?on|recap|r(?:e|\u00e9)cap|nouveaut(?:e|\u00e9)s?|sorties?|semaine|quel|quelle|quels|qu[' ]?est[- ]?ce|c[' ]?est quoi|temps|aujourd|meteo|m(?:e|\u00e9|\u00c3\u00a9|\ufffd)t(?:e|\u00e9|\u00c3\u00a9|\ufffd)o|pluie|vent|neige|fait-il|fait il|qui est|qui etait|qui (?:e|\u00e9)tait|biographie|presentation|pr(?:e|\u00e9)sentation|expos(?:e|\u00e9)|calcule|calculer|combien|convertis|convertir|euros?|dollars?|taux|avec|plusieurs|fiables?|limites?|pour)\b/i.test(
    question
  )
    ? "fr"
    : "en";
