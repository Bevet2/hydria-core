...
const DIRECT_FACT_LOOKUP_PATTERN =
  /\b(?:who is|who was|what is|what are|what was|what were|what causes|why was|tell me about|do you know|rules? of|how (?:do you play|to play)|biography|history of|explain|describe|qui est|qui etait|qui \u00e9tait|tu connais|connais[- ]?tu|r(?:e|\u00e8|\u00e9|\?|\ufffd|\u00c3\u00a8|\u00c3\u00a9)gles? d(?:e|u|es|e la)|comment jouer|comment joue[- ]?t[- ]?on|qu[' ]?est[- ]?ce qu[' ]?(?:un|une|le|la|les)?|qu[' ]?est[- ]?ce que|c[' ]?est quoi|biographie|histoire de|fiche .* sur|explique|raconte|define|definition|d[e\u00e9]finis)\b/i;
