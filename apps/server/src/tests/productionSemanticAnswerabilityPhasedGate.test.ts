...
test("semantic answerability phased gate defaults to 50 then 100 cases", () => {
  assert.deepEqual(parseSemanticAnswerabilityPhases(undefined), [50, 100]);
...
test("semantic answerability first 100 cases stay source-backed for humiliating factual coverage", () => {
