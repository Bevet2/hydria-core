...
const fuzzyAndCorrectionSourceable = [
  ...
  ["java_language_correction_en", "I meant Java the programming language, not the island. What is it?", "Java programming language"],
  ["mercury_planet_correction_en", "I mean Mercury the planet, not the element. What is it?", "Mercury planet"],
  ...
  ["d_day_en", "What was D-Day?", "Normandy landings"],
