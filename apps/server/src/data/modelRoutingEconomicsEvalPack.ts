...
export const modelRoutingEconomicsEvalPack: ModelRoutingEconomicsEvalCase[] = [
  {
    ...
    surface: "chat_route",
    priority: "critical",
    description: "Stable historical/biography questions should avoid the weak 3B factual route and use the local Mistral factual writer.",
  ...
  },
  {
    ...
    surface: "chat_route",
    priority: "critical",
    description: "Strategic conflict with explicit decision pressure should route to the CPU-safe local deep reasoner.",
